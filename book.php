...
<script>
    document.getElementById('proceedToPayButton').addEventListener('click', function() {
        ...
        // Make AJAX request to process the booking
...
// Load Cart Items and Update Total
...
// Show booking form when checkout button is clicked
...
<script>
  ...
  // Dynamically update cart items and total (example)
  function updateCart() {
      const cartItems = [
          { name: 'Item 1', price: 20 },
          { name: 'Item 2', price: 39.98 }
      ];
