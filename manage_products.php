...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Active Link Style */
        .sidebar a.active {
            background-color: #45a049; /* Highlight the active link */
        }
        ...
        /* Manage Products, Orders, Settings Styling */
        .manage-section {
            display: flex;
            flex-direction: column;
            margin-top: 30px;
        ...
        .manage-section .section-title {
            font-size: 18px;
            margin-bottom: 10px;
            color: #333;
        }

        .manage-section .section-content {
        ...
        /* Button Styling for Manage Products */
        button {
            padding: 10px;
