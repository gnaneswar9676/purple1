...
<div class="container">
    <div class="forms-container">
        ...
        <?php if (isset($_SESSION["user"]) || isset($_SESSION["admin"])): ?>
            ...
            <script>
                setTimeout(function() {
                    window.location.href = '<?php echo isset($_SESSION["admin"]) ? "admin_dashboard.php" : "index.php"; ?>';
                }, 2000);
            </script>
        <?php else: ?>
            ...
            <div class="register-form" style="display: none;">
                ...
                <form action="" method="POST">
                    ...
                    <p class="toggle-form">Already have an account? <span id="switch-to-user-login-2">Login</span></p>
                </form>
            </div>
...
<script>
    ...
    document.getElementById("switch-to-user-login-2").addEventListener("click", function() {
        document.querySelector(".register-form").style.display = "none";
        document.querySelector(".login-form").style.display = "block";
    });
</script>
